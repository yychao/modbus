...
/* Name of package */
#define PACKAGE _T("libmodbus")

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT _T("https://github.com/stephane/libmodbus/issues")

/* Define to the full name of this package. */
#define PACKAGE_NAME _T("libmodbus")

/* Define to the full name and version of this package. */
#define PACKAGE_STRING _T("libmodbus 3.1.2")

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME _T("libmodbus")
